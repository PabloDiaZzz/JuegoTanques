...
export class Preloader extends Scene {
    ...
    init() {
        ...
        this.add.rectangle(screen.availWidth / 2, screen.availHeight / 2, 468, 32).setStrokeStyle(1, 0xffffff);

        //  This is the progress bar itself. It will increase in size from the left based on the % of progress.
        const bar = this.add.rectangle(screen.availWidth / 2 - 230, screen.availHeight / 2, 4, 28, 0xffffff);
    ...
    preload() {
        ...
        this.load.html('characterSelect', 'characterSelect.html');
        this.load.css('characterSelectCss', 'characterSelect.css');
    }
